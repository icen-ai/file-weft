...
import ai.icen.fw.application.security.MAX_TRUSTED_USER_ID_LENGTH
...
internal fun validatedResumableUploadOwnerId(ownerId: String): String =
    validatedTrustedUserId(ownerId, "Upload session owner id")
