...
class FlowWeftWorkflowWebBoot2Controller(
    private val runtime: WorkflowWebControllerRuntime,
    private val ports: FlowWeftWorkflowWebBoot2ApplicationPorts,
    codec: FlowWeftWorkflowWebBoot2JsonCodec,
) {
    private val requests = FlowWeftWorkflowWebBoot2RequestSupport(codec)
