...
class DocumentV1DoctorControllerMockMvcTest {
    @Test
    ...
    fun `public Doctor handlers accept no tenant user role or evidence switches`() {
        val parameters = (DocumentV1DoctorController::class.java.declaredMethods +
            SystemV1DoctorController::class.java.declaredMethods)
    ...
    private fun mvc(facade: DoctorApiFacade): MockMvc {
        ...
        return MockMvcBuilders.standaloneSetup(
            DocumentV1DoctorController(facade, responses, traces),
            SystemV1DoctorController(facade, responses, traces),
