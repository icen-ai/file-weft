...
class DocumentV1AuditLogControllerMockMvcTest {
    @Test
    ...
    fun `maps denied missing and unavailable capabilities without leaking context`() {
        val denied = Boot2AuditLogControllerFixture().apply {
        ...
        val missing = Boot2AuditLogControllerFixture().apply { documentMissing = true }
    ...
    private fun mvc(
        fixture: Boot2AuditLogControllerFixture,
    ...
    private fun mvc(
        ...
        DocumentV1AuditLogController(facade, V1ApiResponseFactory(), traces),
    ...
    private companion object {
        ...
        val TRACE_ID = Identifier("trace-http-audit-2")
    }
}

internal class Boot2AuditLogControllerFixture {
