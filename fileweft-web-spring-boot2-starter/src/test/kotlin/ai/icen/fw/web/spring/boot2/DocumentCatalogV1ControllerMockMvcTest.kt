...
class DocumentCatalogV1ControllerMockMvcTest {
    @Test
    fun `browses visible folders moves a document and rejects head on Boot 2`() {
    ...
    @Test
    fun `maps catalog MVC failures to the fixed safe envelope on Boot 2`() {
    ...
    private fun mvc(moveAction: (Identifier, String) -> Document): org.springframework.test.web.servlet.MockMvc {
        ...
        val handler = DocumentCatalogV1RequestFailureHandler(responses, null)
        return MockMvcBuilders.standaloneSetup(
            DocumentCatalogV1Controller(
