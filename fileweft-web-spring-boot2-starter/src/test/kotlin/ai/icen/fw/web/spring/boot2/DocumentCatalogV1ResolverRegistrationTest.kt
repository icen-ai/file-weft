...
class DocumentCatalogV1ResolverRegistrationTest {
    @Test
    fun `catalog WebMvcConfigurer installs the safe request failure resolver on Boot 2`() {
    ...
    class TestConfiguration {
        ...
        ): DocumentCatalogV1Controller = DocumentCatalogV1Controller(facade, responses)

        @Bean
        fun catalogFailureHandler(responses: V1ApiResponseFactory): DocumentCatalogV1RequestFailureHandler =
            DocumentCatalogV1RequestFailureHandler(responses, null)
    }
}
