...
class FlowWeftAgentWebBoot2ControllerTest {
    @Test
    fun `controller exposes exactly the committed route catalog`() {
        val base = FlowWeftAgentWebBoot2Controller::class.java.getAnnotation(RequestMapping::class.java).value.single()
        val actual = FlowWeftAgentWebBoot2Controller::class.java.declaredMethods.flatMap { method ->
    ...
    private fun controller(
        ...
        FlowWeftAgentWebBoot2ApplicationPorts(conversations, runs, null, configuration, null),
        contexts,
