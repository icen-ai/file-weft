...
class FlowWeftAgentWebBoot2Controller(
    private val ports: FlowWeftAgentWebBoot2ApplicationPorts,
    contexts: ai.icen.fw.agent.web.api.AgentWebTrustedContextProvider,
    codec: FlowWeftAgentWebBoot2JsonCodec,
) {
    private val requests = FlowWeftAgentWebBoot2RequestSupport(codec, contexts)
