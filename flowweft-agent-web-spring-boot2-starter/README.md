# FlowWeft Agent Web Spring Boot 2 Starter

Servlet/Jackson HTTP adapter for all 25 routes in `AgentWebRoute`. It targets Java 8 and the
`javax.servlet` Spring Boot 2 stack. The starter does not authenticate users, load providers,
