...
class V1WorkflowDecisionEvidenceControllerTest {
    @Test
    fun `returns privileged actor snapshots while keeping assignments comments and tenants redacted`() {
        val fixture = Boot3WorkflowDecisionEvidenceFixture()
    ...
    @Test
    fun `maps denied and hidden documents without leaking host policy or ids`() {
        val denied = Boot3WorkflowDecisionEvidenceFixture().apply {
            deniedAction = "document:audit"
        }
        ...
        val hidden = Boot3WorkflowDecisionEvidenceFixture().apply { documentMissing = true }
    ...
    private fun mvc(fixture: Boot3WorkflowDecisionEvidenceFixture): MockMvc = MockMvcBuilders.standaloneSetup(
        V1WorkflowDecisionEvidenceController(
...
internal class Boot3WorkflowDecisionEvidenceFixture {
