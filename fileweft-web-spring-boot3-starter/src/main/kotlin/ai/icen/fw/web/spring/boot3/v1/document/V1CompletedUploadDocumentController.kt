...
/** Spring Boot 3 JSON edge for atomically consuming completed uploads as document content. */
@RestController
@RequestMapping(
    value = ["/fileweft/v1/documents"],
    produces = [MediaType.APPLICATION_JSON_VALUE],
)
class V1CompletedUploadDocumentController(
    ...
    private fun executeCreated(action: () -> DocumentCommandResultDto): ResponseEntity<ApiResponse<Any?>> {
        ...
        return try {
            ...
            builder.body(responses.success<Any?>(result, traceId))
