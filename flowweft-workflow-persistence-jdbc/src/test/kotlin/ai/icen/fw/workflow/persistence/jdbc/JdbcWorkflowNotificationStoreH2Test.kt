...
class JdbcWorkflowNotificationStoreH2Test {
    ...
    fun `batch enqueue is atomic tenant scoped and exact replay only`() {
        ...
        val store = JdbcWorkflowNotificationStore(dataSource, WorkflowJdbcDialect.MYSQL)
    ...
    private fun dataSource(): JdbcDataSource = JdbcDataSource().apply {
        ...
        connection.use { connection ->
            val path = "/ai/icen/fw/workflow/db/migration/mysql/V035__persist_workflow_notification_lifecycle.sql"
