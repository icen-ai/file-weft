...
class JdbcWorkflowNotificationStore @JvmOverloads constructor(
    ...
    private companion object {
        ...
        fun insertBatchSql(dialect: WorkflowJdbcDialect): String = when (dialect) {
            WorkflowJdbcDialect.MYSQL -> INSERT_BATCH_SQL + " ON DUPLICATE KEY UPDATE id = id"
            WorkflowJdbcDialect.POSTGRESQL,
            WorkflowJdbcDialect.KINGBASE -> INSERT_BATCH_SQL + " ON CONFLICT DO NOTHING"
        }
