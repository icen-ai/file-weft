-- FlowWeft generic Workflow owns this V030+ MySQL 8 migration line. It is independent of V001-V029.
CREATE TABLE fw_wf_definition (
    ...
    latest_version_id varbinary(512),
...
CREATE TABLE fw_wf_definition_version (
    ...
    definition_payload longblob NOT NULL,
    execution_receipt_id varbinary(512) NOT NULL,
...
CREATE TABLE fw_wf_instance (
    ...
    initiator_id varbinary(512) NOT NULL,
...
CREATE TABLE fw_wf_token (
    ...
    waiting_execution_id varbinary(512),
...
CREATE TABLE fw_wf_human_task (
    ...
    tenant_id varbinary(512) NOT NULL,
    instance_id varbinary(512) NOT NULL,
    node_execution_id varbinary(512) NOT NULL,
    token_id varbinary(512) NOT NULL,
    node_id varchar(128) NOT NULL,
...
CREATE TABLE fw_wf_human_candidate (
    ...
    principal_id varbinary(512) NOT NULL,
...
CREATE TABLE fw_wf_event (
    ...
    token_id varbinary(512),
    node_execution_id varbinary(512),
    work_item_id varbinary(512),
    node_id varchar(128),
    subject_type varchar(64) NOT NULL,
    subject_id varbinary(512) NOT NULL,
    subject_revision varchar(256) NOT NULL,
...
CREATE TABLE fw_wf_effect (
    ...
    lease_id varbinary(512),
    worker_id varbinary(512),
...
CREATE TABLE fw_wf_idempotency (
    ...
    tenant_id varbinary(512) NOT NULL,
    instance_id varbinary(512) NOT NULL,
    idempotency_key varbinary(512) NOT NULL,
...
CREATE TABLE fw_wf_lease (
    ...
    owner_id varbinary(512) NOT NULL,
    worker_id varbinary(512) NOT NULL,
