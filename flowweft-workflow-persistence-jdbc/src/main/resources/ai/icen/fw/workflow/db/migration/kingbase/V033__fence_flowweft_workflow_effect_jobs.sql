...
ALTER TABLE fw_wf_job ADD COLUMN lease_id varchar(512);
ALTER TABLE fw_wf_job ADD COLUMN worker_id varchar(512);
...
ALTER TABLE fw_wf_job ADD COLUMN claim_request_digest varchar(64);
...
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_authority varchar(128);
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_snapshot_revision varchar(256);
ALTER TABLE fw_wf_human_candidate ADD COLUMN resolution_request_digest varchar(64);
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_provider_revision varchar(256);
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_snapshot_digest varchar(64);
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_snapshot_receipt_digest varchar(64);
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_confirmation_revision varchar(256);
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_confirmation_snapshot_digest varchar(64);
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_confirmation_request_digest varchar(64);
ALTER TABLE fw_wf_human_candidate ADD COLUMN organization_confirmation_receipt_digest varchar(64);
