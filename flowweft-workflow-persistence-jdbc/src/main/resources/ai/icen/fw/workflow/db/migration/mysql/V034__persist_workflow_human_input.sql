...
CREATE TABLE fw_wf_human_input_idem (
    ...
    idempotency_key varbinary(512) NOT NULL, operation_code varchar(64) NOT NULL,
    ...
    result_digest varchar(64), result_payload longblob,
...
CREATE TABLE fw_wf_form_submission_ref (
    id varbinary(512) NOT NULL, tenant_id varbinary(512) NOT NULL, submission_version bigint NOT NULL,
    ...
    submitted_by_type varchar(64) NOT NULL, submitted_by_id varbinary(512) NOT NULL,
...
CREATE TABLE fw_wf_structured_comment (
    id varbinary(512) NOT NULL, tenant_id varbinary(512) NOT NULL, comment_version bigint NOT NULL,
    instance_id varbinary(512) NOT NULL, instance_version bigint NOT NULL,
    work_item_id varbinary(512), work_item_version bigint,
...
CREATE TABLE fw_wf_structured_comment_token (
    id varbinary(64) NOT NULL, tenant_id varbinary(512) NOT NULL,
    comment_id varbinary(512) NOT NULL, comment_version bigint NOT NULL, token_ordinal integer NOT NULL,
    token_kind varchar(32) NOT NULL, text_content longtext,
    principal_type varchar(64), principal_id varbinary(512), display_name_snapshot varchar(1024),
...
CREATE TABLE fw_wf_mention_notification_result (
    id varbinary(64) NOT NULL, tenant_id varbinary(512) NOT NULL,
    idempotency_key varbinary(512) NOT NULL, delivery_status varchar(32) NOT NULL,
    provider_message_ref varbinary(512), evidence_digest varchar(64) NOT NULL,
