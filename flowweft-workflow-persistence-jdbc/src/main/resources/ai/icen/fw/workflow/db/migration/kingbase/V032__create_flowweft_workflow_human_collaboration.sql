...
ALTER TABLE fw_wf_human_task ADD COLUMN active_delegate_id varchar(512);
...
CREATE TABLE fw_wf_human_collaboration_event (
    ...
    target_type varchar(64), target_id varchar(512),
    owner_before_type varchar(64), owner_before_id varchar(512),
    owner_after_type varchar(64), owner_after_id varchar(512),
    delegate_before_type varchar(64), delegate_before_id varchar(512),
    delegate_after_type varchar(64), delegate_after_id varchar(512),
    authorization_receipt_digest varchar(64) NOT NULL,
    execution_nonce varchar(512) NOT NULL,
