...
CREATE TABLE fw_wf_notification_batch (
    ...
    origin_idempotency_key varchar(512) NOT NULL, origin_intent_digest varchar(64) NOT NULL,
    batch_digest varchar(64) NOT NULL, authorization_evidence_digest varchar(64) NOT NULL,
    envelope_count integer NOT NULL, first_envelope_id varchar(512) NOT NULL,
...
CREATE TABLE fw_wf_notification_envelope (
    ...
    batch_id varchar(64) NOT NULL, batch_ordinal integer NOT NULL,
    deduplication_key varchar(512) NOT NULL, origin_intent_digest varchar(64) NOT NULL,
    envelope_digest varchar(64) NOT NULL, envelope_payload bytea NOT NULL,
    queue_status varchar(32) NOT NULL, record_version bigint NOT NULL, attempt_count integer NOT NULL,
    lease_id varchar(512), worker_id varchar(512), fencing_token bigint NOT NULL,
    lease_acquired_time bigint, lease_expires_time bigint, next_attempt_time bigint,
    provider_request_digest varchar(64), provider_evidence_payload bytea,
...
CREATE TABLE fw_wf_notification_delivery_report (
    id varchar(512) NOT NULL, tenant_id varchar(512) NOT NULL, envelope_id varchar(512) NOT NULL,
    provider_id varchar(128) NOT NULL, provider_revision varchar(1024) NOT NULL,
    provider_message_ref varchar(1024) NOT NULL, delivery_status varchar(32) NOT NULL,
