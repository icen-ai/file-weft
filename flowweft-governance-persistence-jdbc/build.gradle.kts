...
fun registerGovernanceDatabaseIntegrationTest(
    taskName: String,
    testPattern: String,
    enabledEnvironmentVariable: String,
): org.gradle.api.tasks.TaskProvider<Test> = tasks.register<Test>(taskName) {
    group = "verification"
    description = "Runs the FlowWeft Governance migration and JDBC contract on a dedicated real database."
    ...
    doNotTrackState("The Governance database contract must execute against the current real database service.")
    doFirst {
...
registerGovernanceDatabaseIntegrationTest(
    "governancePostgresIntegrationTest",
    "**/GovernancePostgresIntegrationTest.class",
    "FILEWEFT_RUN_POSTGRES_TESTS",
)
registerGovernanceDatabaseIntegrationTest(
    "governanceMySqlIntegrationTest",
    "**/GovernanceMySQLIntegrationTest.class",
    "FILEWEFT_RUN_MYSQL_TESTS",
)
registerGovernanceDatabaseIntegrationTest(
    "governanceKingbaseIntegrationTest",
    "**/GovernanceKingbaseIntegrationTest.class",
