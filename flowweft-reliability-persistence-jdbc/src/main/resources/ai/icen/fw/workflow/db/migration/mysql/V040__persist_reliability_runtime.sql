-- FlowWeft reliability runtime: MySQL 8 V040
CREATE TABLE fw_reliability_run (
    ...
    state_memento LONGBLOB NOT NULL,
...
CREATE TABLE fw_reliability_provider_attempt (
    id VARCHAR(512) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    tenant_id VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
    run_id VARCHAR(512) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    operation_kind VARCHAR(32) NOT NULL,
    provider_id VARCHAR(128) NOT NULL,
    provider_revision VARCHAR(256) NOT NULL,
    ...
    attempt_memento LONGBLOB NOT NULL,
...
CREATE TABLE fw_reliability_provider_receipt (
    ...
    evidence_memento LONGBLOB NOT NULL,
...
CREATE TABLE fw_reliability_slo_evaluation (
    id VARCHAR(512) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    tenant_id VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
    schedule_id VARCHAR(512) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    schedule_version BIGINT NOT NULL,
    evaluation_digest CHAR(64) NOT NULL,
    alert_digest CHAR(64) NOT NULL,
    record_memento LONGBLOB NOT NULL,
