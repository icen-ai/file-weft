...
/** Starts a clean Boot 3 consumer from the same dependency set recommended in the documentation. */
class Boot3JdbcStartupSmokeTest {
    @TempDir
    Path storageRoot;
    ...
    void hostJdbcStarterCreatesTheDataSourceAndFormalDocumentWriteEntry() throws IOException {
        ...
        try (ConfigurableApplicationContext context = application.run()) {
            ...
            assertNotNull(context.getBean(V1DocumentWriteController.class));
