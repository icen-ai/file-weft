...
CREATE TABLE fw_agent_run (
    ...
    tenant_key_digest char(64) NOT NULL,
    ...
    idempotency_replay_digest char(64) NOT NULL,
    admission_binding_digest char(64) NOT NULL,
    admission_decision_digest char(64) NOT NULL,
    ...
    current_operation_kind varchar(16),
    current_operation_phase varchar(64),
    current_operation_digest char(64),
    current_checkpoint_id varchar(512),
    state_memento_schema varchar(64) NOT NULL,
    state_memento_format_version integer NOT NULL,
    state_memento_digest char(64) NOT NULL,
    state_memento_payload bytea NOT NULL,
...
CREATE INDEX idx_fw_agent_run_recoverable
    ON fw_agent_run(run_status, lease_expires_time, updated_time, tenant_key_digest, id);
CREATE INDEX idx_fw_agent_run_tenant
    ON fw_agent_run(tenant_key_digest, updated_time, id);
...
CREATE TABLE fw_agent_idempotency (
    ...
    idempotency_replay_digest char(64) NOT NULL,
    run_record_id char(64) NOT NULL,
    run_id varchar(512) NOT NULL,
    admission_binding_digest char(64) NOT NULL,
    admission_decision_digest char(64) NOT NULL,
    created_time bigint NOT NULL,
...
CREATE INDEX idx_fw_agent_idempotency_run
    ON fw_agent_idempotency(tenant_key_digest, run_record_id);
...
CREATE TABLE fw_agent_event (
    ...
    event_memento_schema varchar(64) NOT NULL,
    event_memento_format_version integer NOT NULL,
    event_memento_digest char(64) NOT NULL,
    event_memento_payload bytea NOT NULL,
    created_time bigint NOT NULL,
    updated_time bigint NOT NULL,
...
CREATE INDEX idx_fw_agent_event_tenant_run
    ON fw_agent_event(tenant_key_digest, run_record_id, event_sequence);
...
CREATE TABLE fw_agent_operation (
    ...
    operation_phase varchar(64) NOT NULL,
    operation_outcome varchar(32) NOT NULL,
    logical_operation_digest char(64) NOT NULL,
    ...
    execution_context_receipt_status varchar(32),
    dispatch_fence_id varchar(512),
    dispatch_fence_binding_digest char(64),
    dispatch_receipt_id varchar(512),
    dispatch_receipt_status varchar(32),
    ...
    outcome_time bigint,
    outcome_binding_digest char(64),
    operation_memento_schema varchar(64) NOT NULL,
    operation_memento_format_version integer NOT NULL,
    operation_memento_digest char(64) NOT NULL,
    operation_memento_payload bytea NOT NULL,
...
CREATE INDEX idx_fw_agent_operation_tenant_run
    ON fw_agent_operation(tenant_key_digest, run_record_id, updated_time, id);
CREATE INDEX idx_fw_agent_operation_reconcile
    ON fw_agent_operation(operation_outcome, updated_time, tenant_key_digest, id);
