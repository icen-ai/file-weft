...
> [!NOTE]
> FileWeft never rolls back already-succeeded targets. Required target failures move the document to `SYNC_ERROR`; optional failures leave it `PUBLISHED` with recorded errors.
...
FileWeft fails closed. A 403 usually means one of:
