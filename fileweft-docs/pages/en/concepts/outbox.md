...
The rule is simple: **local atomic, explicit convergence**. FileWeft promises atomicity on the local database; it does not promise a distributed transaction across PostgreSQL, object storage and downstream systems.
...
FileWeft exposes outbox backlog through Micrometer / Prometheus gauges:
