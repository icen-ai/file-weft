...
class FlowWeftWorkflowWebBoot3JsonCodec(objectMapper: ObjectMapper) {
...
internal class FlowWeftWorkflowWebBoot3RequestSupport(
    private val codec: FlowWeftWorkflowWebBoot3JsonCodec,
) {
    fun handle(
