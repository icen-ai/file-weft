...
class FlowWeftWorkflowWebBoot3ControllerTest {
    ...
    ): FlowWeftWorkflowWebBoot3Controller = FlowWeftWorkflowWebBoot3Controller(
        WorkflowWebControllerRuntime(contextProvider),
        FlowWeftWorkflowWebBoot3ApplicationPorts(capabilities, definitions, instances, tasks, null, operations),
