...
dependencies {
    ...
    constraints {
        api(libs.tomcat.embed.core) {
            ...
            because("The Workflow web starter must retain the repository's security-patched Tomcat baseline")
        }
        ...
        api(libs.logback.classic) {
            ...
            because("The Workflow web starter must retain the repository's security-patched Logback baseline")
        }
