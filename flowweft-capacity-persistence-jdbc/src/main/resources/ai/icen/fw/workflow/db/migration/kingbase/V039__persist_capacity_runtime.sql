...
CREATE TABLE fw_capacity_policy_workload (
    ...
    updated_time BIGINT NOT NULL,
    PRIMARY KEY (id),
    FOREIGN KEY (policy_row_id) REFERENCES fw_capacity_policy (id) ON DELETE CASCADE
);
...
CREATE TABLE fw_capacity_policy_snapshot (
    ...
    resolution_memento BYTEA NOT NULL,
...
CREATE TABLE fw_capacity_measure (
    ...
    updated_time BIGINT NOT NULL,
    PRIMARY KEY (id),
    FOREIGN KEY (state_id) REFERENCES fw_capacity_state (id) ON DELETE CASCADE
);
