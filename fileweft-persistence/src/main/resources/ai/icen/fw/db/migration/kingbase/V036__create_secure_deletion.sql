...
CREATE INDEX idx_fw_sec_del_plan_status
    ON fw_secure_deletion_plan(tenant_id, execution_status, updated_time, id);
CREATE INDEX idx_fw_sec_del_plan_resource
    ON fw_secure_deletion_plan(tenant_id, resource_type, resource_id, resource_revision);
...
CREATE INDEX idx_fw_sec_del_tomb_revision
    ON fw_secure_deletion_tombstone(tenant_id, resource_type, resource_id, resource_revision);
...
(
    ...
    active_legal_hold_ids_json   jsonb         NOT NULL,
...
CREATE INDEX idx_fw_sec_del_audit_resource
    ON fw_secure_deletion_audit(tenant_id, resource_type, resource_id, occurred_time DESC);
CREATE INDEX idx_fw_sec_del_audit_plan
    ON fw_secure_deletion_audit(tenant_id, plan_id, evidence_type);
...
CREATE INDEX idx_fw_sec_del_receipt_status
    ON fw_secure_deletion_receipt(tenant_id, provider_status, updated_time, plan_id);
