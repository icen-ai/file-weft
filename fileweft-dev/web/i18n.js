...
export const messages = {
  en: {
    ...
    "evidence.versions": "Version evidence", "evidence.workflow": "Review trail", "evidence.sync": "Sync records", "evidence.audit": "Audit trail", "evidence.operation": "Operation trace", "evidence.agent": "Agent suggestions", "empty.agent": "No agent result has been produced", "action.confirmAgent": "Confirm suggestion", "agent.confirmed": "CONFIRMED", "agent.capability.CLASSIFICATION": "Classification", "notice.agentConfirmed": "Agent suggestion confirmed with audit evidence.", "operation.trace": "Trace ID", "operation.noTrace": "No request trace", "form.newTitle": "New title", "form.version": "Version, for example 1.1", "form.file": "New version file",
    "action.doctor": "Run Doctor", "action.download": "Download", "action.rename": "Rename", "action.addVersion": "Add version", "action.submit": "Submit for review", "action.approve": "Approve", "action.reject": "Reject", "action.revise": "Return to draft", "action.offline": "Take offline", "action.archive": "Archive",
  ...
  zh: {
    ...
    "evidence.versions": "版本证据", "evidence.workflow": "审批轨迹", "evidence.sync": "同步记录", "evidence.audit": "审计日志", "evidence.operation": "操作追踪", "evidence.agent": "Agent 建议", "empty.agent": "尚未产生 Agent 结果", "action.confirmAgent": "确认建议", "agent.confirmed": "已确认", "agent.capability.CLASSIFICATION": "分类", "notice.agentConfirmed": "Agent 建议已确认并写入审计证据。", "operation.trace": "追踪号", "operation.noTrace": "无请求追踪号", "form.newTitle": "新标题", "form.version": "版本号，例如 1.1", "form.file": "新版文件",
    "action.doctor": "诊断 Doctor", "action.download": "下载", "action.rename": "重命名", "action.addVersion": "追加版本", "action.submit": "提交审批", "action.approve": "通过", "action.reject": "驳回", "action.revise": "修订为草稿", "action.offline": "下线", "action.archive": "归档",
    ...
    "notice.login": "身份已接入，开始验证文档链路。", "notice.fixtureCreated": "样例文件已作为 RustFS 支撑的真实草稿上传。", "notice.download": "已准备经过授权的文档流。", "notice.submitted": "已提交给 alpha-reviewer。", "notice.approved": "审批已通过，等待 Outbox 同步。", "notice.rejected": "已驳回，文档现在可修订。", "notice.readOnly": "只读视图已验证：变更控件由服务端下发的权限集过滤。", "notice.noPending": "当前租户没有可打开的待审批文档。", "notice.outbox": "Outbox：认领 {claimed}，成功 {succeeded}，重试 {retried}，失败 {failed}。",
